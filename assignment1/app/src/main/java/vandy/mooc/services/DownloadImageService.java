...
public class DownloadImageService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        //Set the url as data to intent
        downloadIntent.setData(url);

        //Put the request code as an extra
        ...
        //Put the messenger as an extra
        downloadIntent.putExtra(MESSENGER,messenger);

        //Put the directory path name as an extra
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // @@ TODO -- you fill in here.
        Uri imagePath = Utils.downloadImage(getApplicationContext(),imageUrl,directoryPathName);
        ...
        sendPath(messenger,imagePath,imageUrl);
    }
