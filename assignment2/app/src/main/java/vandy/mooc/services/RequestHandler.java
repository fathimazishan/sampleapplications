...
import vandy.mooc.utils.RequestReplyMessageBase;
...
class RequestHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        final Uri imageUrl = (Uri) requestMessage.getData().get(RequestReplyMessageBase.IMAGE_URL);

        // Get the directory pathname where the image will be stored.
        // TODO -- you fill in here.

        final String directoryPathName = requestMessage.getData().getString(RequestReplyMessageBase.DIRECTORY_PATHNAME);

        // Get the requestCode for the operation that was invoked by
        // the Activity.
        // TODO -- you fill in here.

        final int requestCode = requestMessage.getData().getInt(RequestReplyMessageBase.REQUEST_CODE);
        ...
        final Runnable downloadImageAndReply =
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        Uri pathToFile = Utils.downloadImage(mService.get().getApplicationContext(),imageUrl,directoryPathName);
                        ...
                        sendPath(replyMessenger,pathToFile,imageUrl,requestCode);
